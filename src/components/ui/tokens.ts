export const ui = {
  ...
  typography: {
    ...
    sectionTitle: 'text-lg font-extrabold text-[color:var(--brand-primary)]',
    cardTitle: 'text-base md:text-lg font-semibold text-slate-900',

    // Body copy + meta
    body: 'text-sm md:text-[15px] leading-6 text-slate-600',
    meta: 'text-xs md:text-sm leading-5 text-slate-500',

    // Form typography
    label: 'text-sm font-medium text-slate-700',
    helper: 'text-xs md:text-sm leading-5 text-slate-500',
  },
  focusRing:
  ...
  kpi: {
    ...
    label: 'mt-1 truncate text-sm font-medium text-slate-900',
    subtext: 'mt-1 truncate text-xs md:text-sm leading-5 text-slate-500',
    tone: {
      neutral: 'bg-slate-50',
      sky: 'bg-sky-50',
